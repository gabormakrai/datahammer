...
public class RegressionNeuralNetworkTest {
	...
	public void testLearnCase1() {
		...
		result = RegressionEvaluationFactory.createEvaluator("mae").evaluate(testTable, MarkingType.Test);
		System.out.println(result);

		result = RegressionEvaluationFactory.createEvaluator("rmse").evaluate(testTable, MarkingType.Test);
		System.out.println(result);
